      ...
      <div className={mode}>
        <Routes>
          ...
          <Route path="/" element={<ProtectedRoutes />}>
            ...
            <Route
              path="/news"
              element={<NewsList mode={mode} setMode={setMode} />}
            />

            <Route
              path="/crypto/:id"
              element={<SingleCrypto mode={mode} setMode={setMode} />}
            />
            ...
            <Route
              path="/calculators"
              element={<CurrencyConverter mode={mode} setMode={setMode} />}
            />

            <Route
              path="/developers"
              element={<DeveloperList mode={mode} setMode={setMode} />}
            />
          </Route>
        </Routes>
      </div>
